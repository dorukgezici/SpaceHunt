	...
	constructor(bootstrap: GameBootstrap) {
		super(
			...
			(bootstrap.state.names.length === 2
				? ([new Level1Player(100, 0, Level1.levelBounds.right, controlSets.controls1),
				new Level1Player(30, 0, Level1.levelBounds.right, controlSets.controls2)]) // two players required
				: ([new Level1Player(100, 0, Level1.levelBounds.right, controlSets.controls1)])), // just one player required
