...
declare namespace JSX {
	...
	type ElementBase = DOMElement;
	type Element = ElementBase | unset;
	type ElementCollection = Element | Element[];
	type Node = ElementBase | string | number | boolean | unset;
	type NodeCollection = Node | Node[];
	type TruthyNode = ElementBase | string | number | true;
	type FalsyNode = false | unset;
	type Children = Node[];
	type DefaultAttrs = EmptyObject;
	type ElementAttrs<E extends keyof IntrinsicElements> = IntrinsicElements[E];
	...
	type SvgAttrs<T extends DOMElement> = SVGAttributes<T> & ClassAttributes<T>;

	interface ElementAttributesProperty<T extends AttrsType = DefaultAttrs> {
		/**
	...
	interface IntrinsicElements {
		// HTML
		a: IntrinsicElementType<AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement>;
		abbr: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		address: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		area: IntrinsicElementType<AreaHTMLAttributes<HTMLAreaElement>, HTMLAreaElement>;
		article: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		aside: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		audio: IntrinsicElementType<AudioHTMLAttributes<HTMLAudioElement>, HTMLAudioElement>;
		b: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		base: IntrinsicElementType<BaseHTMLAttributes<HTMLBaseElement>, HTMLBaseElement>;
		bdi: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		bdo: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		big: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		blockquote: IntrinsicElementType<BlockquoteHTMLAttributes<HTMLElement>, HTMLElement>;
		body: IntrinsicElementType<HTMLAttributes<HTMLBodyElement>, HTMLBodyElement>;
		br: IntrinsicElementType<HTMLAttributes<HTMLBRElement>, HTMLBRElement>;
		button: IntrinsicElementType<ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>;
		canvas: IntrinsicElementType<CanvasHTMLAttributes<HTMLCanvasElement>, HTMLCanvasElement>;
		caption: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		cite: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		code: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		col: IntrinsicElementType<ColHTMLAttributes<HTMLTableColElement>, HTMLTableColElement>;
		colgroup: IntrinsicElementType<ColgroupHTMLAttributes<HTMLTableColElement>, HTMLTableColElement>;
		data: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		datalist: IntrinsicElementType<HTMLAttributes<HTMLDataListElement>, HTMLDataListElement>;
		dd: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		del: IntrinsicElementType<DelHTMLAttributes<HTMLElement>, HTMLElement>;
		details: IntrinsicElementType<DetailsHTMLAttributes<HTMLElement>, HTMLElement>;
		dfn: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		dialog: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		div: IntrinsicElementType<HTMLAttributes<HTMLDivElement>, HTMLDivElement>;
		dl: IntrinsicElementType<HTMLAttributes<HTMLDListElement>, HTMLDListElement>;
		dt: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		em: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		embed: IntrinsicElementType<EmbedHTMLAttributes<HTMLEmbedElement>, HTMLEmbedElement>;
		fieldset: IntrinsicElementType<FieldsetHTMLAttributes<HTMLFieldSetElement>, HTMLFieldSetElement>;
		figcaption: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		figure: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		footer: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		form: IntrinsicElementType<FormHTMLAttributes<HTMLFormElement>, HTMLFormElement>;
		h1: IntrinsicElementType<HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement>;
		h2: IntrinsicElementType<HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement>;
		h3: IntrinsicElementType<HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement>;
		h4: IntrinsicElementType<HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement>;
		h5: IntrinsicElementType<HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement>;
		h6: IntrinsicElementType<HTMLAttributes<HTMLHeadingElement>, HTMLHeadingElement>;
		head: IntrinsicElementType<HTMLAttributes<HTMLHeadElement>, HTMLHeadElement>;
		header: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		hgroup: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		hr: IntrinsicElementType<HTMLAttributes<HTMLHRElement>, HTMLHRElement>;
		html: IntrinsicElementType<HtmlHTMLAttributes<HTMLHtmlElement>, HTMLHtmlElement>;
		i: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		iframe: IntrinsicElementType<IframeHTMLAttributes<HTMLIFrameElement>, HTMLIFrameElement>;
		img: IntrinsicElementType<ImgHTMLAttributes<HTMLImageElement>, HTMLImageElement>;
		input: IntrinsicElementType<InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>;
		ins: IntrinsicElementType<InsHTMLAttributes<HTMLModElement>, HTMLModElement>;
		kbd: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		keygen: IntrinsicElementType<KeygenHTMLAttributes<HTMLElement>, HTMLElement>;
		label: IntrinsicElementType<LabelHTMLAttributes<HTMLLabelElement>, HTMLLabelElement>;
		legend: IntrinsicElementType<HTMLAttributes<HTMLLegendElement>, HTMLLegendElement>;
		li: IntrinsicElementType<LiHTMLAttributes<HTMLLIElement>, HTMLLIElement>;
		link: IntrinsicElementType<LinkHTMLAttributes<HTMLLinkElement>, HTMLLinkElement>;
		main: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		map: IntrinsicElementType<MapHTMLAttributes<HTMLMapElement>, HTMLMapElement>;
		mark: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		menu: IntrinsicElementType<MenuHTMLAttributes<HTMLElement>, HTMLElement>;
		menuitem: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		meta: IntrinsicElementType<MetaHTMLAttributes<HTMLMetaElement>, HTMLMetaElement>;
		meter: IntrinsicElementType<MeterHTMLAttributes<HTMLElement>, HTMLElement>;
		nav: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		noindex: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		noscript: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		object: IntrinsicElementType<ObjectHTMLAttributes<HTMLObjectElement>, HTMLObjectElement>;
		ol: IntrinsicElementType<OlHTMLAttributes<HTMLOListElement>, HTMLOListElement>;
		optgroup: IntrinsicElementType<OptgroupHTMLAttributes<HTMLOptGroupElement>, HTMLOptGroupElement>;
		option: IntrinsicElementType<OptionHTMLAttributes<HTMLOptionElement>, HTMLOptionElement>;
		output: IntrinsicElementType<OutputHTMLAttributes<HTMLElement>, HTMLElement>;
		p: IntrinsicElementType<HTMLAttributes<HTMLParagraphElement>, HTMLParagraphElement>;
		param: IntrinsicElementType<ParamHTMLAttributes<HTMLParamElement>, HTMLParamElement>;
		picture: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		pre: IntrinsicElementType<HTMLAttributes<HTMLPreElement>, HTMLPreElement>;
		progress: IntrinsicElementType<ProgressHTMLAttributes<HTMLProgressElement>, HTMLProgressElement>;
		q: IntrinsicElementType<QuoteHTMLAttributes<HTMLQuoteElement>, HTMLQuoteElement>;
		rp: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		rt: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		ruby: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		s: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		samp: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		script: IntrinsicElementType<ScriptHTMLAttributes<HTMLScriptElement>, HTMLScriptElement>;
		section: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		select: IntrinsicElementType<SelectHTMLAttributes<HTMLSelectElement>, HTMLSelectElement>;
		small: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		source: IntrinsicElementType<SourceHTMLAttributes<HTMLSourceElement>, HTMLSourceElement>;
		span: IntrinsicElementType<HTMLAttributes<HTMLSpanElement>, HTMLSpanElement>;
		strong: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		style: IntrinsicElementType<StyleHTMLAttributes<HTMLStyleElement>, HTMLStyleElement>;
		sub: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		summary: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		sup: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		table: IntrinsicElementType<TableHTMLAttributes<HTMLTableElement>, HTMLTableElement>;
		tbody: IntrinsicElementType<HTMLAttributes<HTMLTableSectionElement>, HTMLTableSectionElement>;
		td: IntrinsicElementType<TdHTMLAttributes<HTMLTableDataCellElement>, HTMLTableDataCellElement>;
		textarea: IntrinsicElementType<TextareaHTMLAttributes<HTMLTextAreaElement>, HTMLTextAreaElement>;
		tfoot: IntrinsicElementType<HTMLAttributes<HTMLTableSectionElement>, HTMLTableSectionElement>;
		th: IntrinsicElementType<ThHTMLAttributes<HTMLTableHeaderCellElement>, HTMLTableHeaderCellElement>;
		thead: IntrinsicElementType<HTMLAttributes<HTMLTableSectionElement>, HTMLTableSectionElement>;
		time: IntrinsicElementType<TimeHTMLAttributes<HTMLElement>, HTMLElement>;
		title: IntrinsicElementType<HTMLAttributes<HTMLTitleElement>, HTMLTitleElement>;
		tr: IntrinsicElementType<HTMLAttributes<HTMLTableRowElement>, HTMLTableRowElement>;
		track: IntrinsicElementType<TrackHTMLAttributes<HTMLTrackElement>, HTMLTrackElement>;
		u: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		ul: IntrinsicElementType<HTMLAttributes<HTMLUListElement>, HTMLUListElement>;
		"var": IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		video: IntrinsicElementType<VideoHTMLAttributes<HTMLVideoElement>, HTMLVideoElement>;
		wbr: IntrinsicElementType<HTMLAttributes<HTMLElement>, HTMLElement>;
		webview: IntrinsicElementType<WebViewHTMLAttributes<HTMLWebViewElement>, HTMLWebViewElement>;

		// SVG
		// svg: SvgAttrs<SVGSVGElement>;
		// animate: SvgAttrs<SVGElement>; // TODO: It is SVGAnimateElement but is not in TypeScript's lib.dom.d.ts for now.
		// animateTransform: SvgAttrs<SVGElement>; // TODO: It is SVGAnimateTransformElement but is not in TypeScript's lib.dom.d.ts for now.
		// circle: SvgAttrs<SVGCircleElement>;
		// clipPath: SvgAttrs<SVGClipPathElement>;
		// defs: SvgAttrs<SVGDefsElement>;
		// desc: SvgAttrs<SVGDescElement>;
		// ellipse: SvgAttrs<SVGEllipseElement>;
		// feBlend: SvgAttrs<SVGFEBlendElement>;
		// feColorMatrix: SvgAttrs<SVGFEColorMatrixElement>;
		// feComponentTransfer: SvgAttrs<SVGFEComponentTransferElement>;
		// feComposite: SvgAttrs<SVGFECompositeElement>;
		// feConvolveMatrix: SvgAttrs<SVGFEConvolveMatrixElement>;
		// feDiffuseLighting: SvgAttrs<SVGFEDiffuseLightingElement>;
		// feDisplacementMap: SvgAttrs<SVGFEDisplacementMapElement>;
		// feDistantLight: SvgAttrs<SVGFEDistantLightElement>;
		// feFlood: SvgAttrs<SVGFEFloodElement>;
		// feFuncA: SvgAttrs<SVGFEFuncAElement>;
		// feFuncB: SvgAttrs<SVGFEFuncBElement>;
		// feFuncG: SvgAttrs<SVGFEFuncGElement>;
		// feFuncR: SvgAttrs<SVGFEFuncRElement>;
		// feGaussianBlur: SvgAttrs<SVGFEGaussianBlurElement>;
		// feImage: SvgAttrs<SVGFEImageElement>;
		// feMerge: SvgAttrs<SVGFEMergeElement>;
		// feMergeNode: SvgAttrs<SVGFEMergeNodeElement>;
		// feMorphology: SvgAttrs<SVGFEMorphologyElement>;
		// feOffset: SvgAttrs<SVGFEOffsetElement>;
		// fePointLight: SvgAttrs<SVGFEPointLightElement>;
		// feSpecularLighting: SvgAttrs<SVGFESpecularLightingElement>;
		// feSpotLight: SvgAttrs<SVGFESpotLightElement>;
		// feTile: SvgAttrs<SVGFETileElement>;
		// feTurbulence: SvgAttrs<SVGFETurbulenceElement>;
		// filter: SvgAttrs<SVGFilterElement>;
		// foreignObject: SvgAttrs<SVGForeignObjectElement>;
		// g: SvgAttrs<SVGGElement>;
		// image: SvgAttrs<SVGImageElement>;
		// line: SvgAttrs<SVGLineElement>;
		// linearGradient: SvgAttrs<SVGLinearGradientElement>;
		// marker: SvgAttrs<SVGMarkerElement>;
		// mask: SvgAttrs<SVGMaskElement>;
		// metadata: SvgAttrs<SVGMetadataElement>;
		// path: SvgAttrs<SVGPathElement>;
		// pattern: SvgAttrs<SVGPatternElement>;
		// polygon: SvgAttrs<SVGPolygonElement>;
		// polyline: SvgAttrs<SVGPolylineElement>;
		// radialGradient: SvgAttrs<SVGRadialGradientElement>;
		// rect: SvgAttrs<SVGRectElement>;
		// stop: SvgAttrs<SVGStopElement>;
		// switch: SvgAttrs<SVGSwitchElement>;
		// symbol: SvgAttrs<SVGSymbolElement>;
		// text: SvgAttrs<SVGTextElement>;
		// textPath: SvgAttrs<SVGTextPathElement>;
		// tspan: SvgAttrs<SVGTSpanElement>;
		// use: SvgAttrs<SVGUseElement>;
		// view: SvgAttrs<SVGViewElement>;
	}
	...
	// This interface is not complete. Only properties accepting unitless numbers are listed here (see CSSProperty.js in React)
	...
	type HtmlAttrs<T extends DOMElement> = AllHTMLAttributes<T> & ClassAttributes<T>;
